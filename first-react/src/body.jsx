export default function MyMain(params) {
    return(
        <div className="mt-6  container flex flex-col mx-auto justify-center items-center h-auto ">
            ...
            <div className="h-50 w-4/5  sm:w-70 overflow-hidden justify-center flex flex-col items-center rounded-3xl shadow-xl">
                <div className=" relative flex-1/2 bg-gray-50 w-100 flex overflow-hidden justify-center items-center">
            ...
            <div className="h-20 bg-gray-100 mt-3 w-4/5 rounded-2xl flex justify-center items-start overflow-hidden shadow-xl">
            <div className=" flex-1/3 flex justify-center items-center bg-gray-200 h-full">
                    <img src="src\assets\gambar\logo-unpad1.webp" alt="" srcset="" className=" scale-95"/>            
            </div>
            ...
            <div className="h-auto mt-3 w-4/5 justify-between flex items-center rounded-xl flex-wrap bg-amber-50 overflow-hidden z-10 shadow-xl">
            ...
            <div className="h-20 bg-gray-100 mt-3 w-4/5 text-start flex-col p-3 rounded-2xl flex justify-center items-start shadow-xl">
            ...
            <div className="h-50 bg-gray-100 w-4/5 mt-3 justify-center flex items-center rounded-3xl mb-3 shadow-xl ">Project</div>
            <div className="h-20 bg-gray-100 w-4/5 rounded-2xl flex justify-center items-center overflow-hidden">
                <div className=" flex-1/3 bg-gray-200 h-full">
            </div>
                <div className=" flex-1/1 flex flex-col justify-center p-3 shadow-xl">
