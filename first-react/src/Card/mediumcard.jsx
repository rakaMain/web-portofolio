export default function MediumCard(value){
    return(
        <>
        <div className=" w-auto h-100 rounded-2xl flex flex-col items-center justify-center overflow-hidden bg-white border-1 border-neutral-200 relative">
            ...
            <div className=" overflow-hidden flex-1/1  items-start w-full p-4 relative flex flex-col  ">
                ...
                <p className="text-[12px] text-justify">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nesciunt, aperiam. Veniam neque fuga dolor sunt? Est corporis enim quaerat ad!</p>
                <button className="w-25 text-black justify-center bg-[#E6FF28]  flex mt-5 h-12 items-center rounded-md border-1 border-neutral-200 mb-4 ">see more</button>
            </div>
